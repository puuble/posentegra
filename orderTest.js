let queries = {
  queries: {
    ...
    addOrderToTerminalTicket: [
      'mutation m {addOrderToTerminalTicket(terminalId:"{terminalId}",productId:6147,price:85.00,quantity:1,portion:"Normal",orderTags:"Yemeksepeti Etiketi=5 x Lahmacun:Acısız,Yemeksepeti Etiketi=Lahmacun:Acılı"){orders{uid}}}',
    ],
